...
public class FileInfoController {
	 ...
	 * @return
	 */
	@AutoLog(value = "文件信息表-分页列表查询")
	@ApiOperation(value="文件信息表-分页列表查询", notes="文件信息表-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "文件信息表-添加")
	@ApiOperation(value="文件信息表-添加", notes="文件信息表-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "文件信息表-编辑")
	@ApiOperation(value="文件信息表-编辑", notes="文件信息表-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "文件信息表-通过id删除")
	@ApiOperation(value="文件信息表-通过id删除", notes="文件信息表-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "文件信息表-批量删除")
	@ApiOperation(value="文件信息表-批量删除", notes="文件信息表-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "文件信息表-通过id查询")
	@ApiOperation(value="文件信息表-通过id查询", notes="文件信息表-通过id查询")
  ...
  public ModelAndView exportXls(HttpServletRequest request, HttpServletResponse response) {
      ...
      //导出文件名称
      mv.addObject(NormalExcelConstants.FILE_NAME, "文件信息表列表");
      mv.addObject(NormalExcelConstants.CLASS, FileInfo.class);
      mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("文件信息表列表数据", "导出人:Jeecg", "导出信息"));
  ...
  public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
      ...
      for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
          ...
          try {
              List<FileInfo> listFileInfos = ExcelImportUtil.importExcel(file.getInputStream(), FileInfo.class, params);
              fileInfoService.saveBatch(listFileInfos);
              return Result.ok("文件导入成功！数据行数:" + listFileInfos.size());
          } catch (Exception e) {
              log.error(e.getMessage(),e);
